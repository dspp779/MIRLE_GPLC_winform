...
namespace Modbus.TCP
{
    ...
    public class Master
    {
        ...
        internal void CallException(ushort id, byte unit, byte function, ModbusException exception)
        {
            if ((tcpAsyCl == null) || (tcpSynCl == null)) return;
            if (exception.Code == 0xFD)
            {
                tcpSynCl = null;
                tcpAsyCl = null;
            }
        ...
        {
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadCoils), id);
        }
        ...
        {
            values = WriteSyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadCoils), id);
        }
        ...
        {
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadDiscreteInputs), id);
        }
        ...
        {
            values = WriteSyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadDiscreteInputs), id);
        }
        ...
        {
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadHoldingRegisters), id);
        }
        ...
        {
            values = WriteSyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadHoldingRegisters), id);
        }
        ...
        {
            WriteAsyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadInputRegisters), id);
        }
        ...
        {
            values = WriteSyncData(CreateReadHeader(id, unit, startAddress, numInputs, EnumModbusFunctionCode.ReadInputRegisters), id);
        }
        ...
        {
            byte[] data;
            data = CreateWriteHeader(id, unit, startAddress, 1, 1, EnumModbusFunctionCode.WriteSingleCoil);
        ...
        public void WriteMultipleCoils(ushort id, byte unit, ushort startAddress, ushort numBits, byte[] values)
        {
            ...
            byte[] data;
            data = CreateWriteHeader(id, unit, startAddress, numBits, (byte)(numBytes + 2), EnumModbusFunctionCode.WriteMultipleCoils);
        ...
        {
            byte[] data;
            data = CreateWriteHeader(id, unit, startAddress, 1, 1, EnumModbusFunctionCode.WriteSingleRegister);
            data[10] = values[0];
            data[11] = values[1];
            WriteAsyncData(data, id);
        }
        ...
        public void WriteMultipleRegister(ushort id, byte unit, ushort startAddress, byte[] values)
        {
            ...
            data = CreateWriteHeader(id, unit, startAddress, Convert.ToUInt16(numBytes / 2), Convert.ToUInt16(numBytes + 2), EnumModbusFunctionCode.WriteMultipleRegisters);
        ...
        private byte[] CreateReadWriteHeader(ushort id, byte unit, ushort startReadAddress, ushort numRead, ushort startWriteAddress, ushort numWrite)
        {
            ...
            data[5] = _size[1];						// Complete message size in bytes
            data[6] = unit;							// Slave address
            data[7] = (byte) EnumModbusFunctionCode.ReadWriteMultipleRegisters;	// Function code
        ...
        private void WriteAsyncData(byte[] write_data, ushort id)
        {
            ...
            else throw ModbusException.GetModbusException(0xFD);
        }
